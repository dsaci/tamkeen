...
import { SmartSectionProvider } from '../../contexts/SmartSectionContext';
import SmartSection from '../../components/ui/SmartSection';
import GlobalCollapseControl from '../../components/ui/GlobalCollapseControl';
         ...
         <div className="max-w-3xl mx-auto space-y-6">
            <div className="bg-white dark:bg-slate-800 rounded-[2.5rem] p-8 border border-slate-100 dark:border-slate-700 shadow-sm">
               ...
               <div className="space-y-6">
                  <SmartSection title="المظهر" sectionKey="settings-appearance" defaultOpen={true}>
                  ...
                  <SmartSection title="الاسم المعروض" sectionKey="settings-name" defaultOpen={true}>
                  ...
                  <SmartSection title="مفتاح Gemini API" sectionKey="settings-gemini" defaultOpen={true}>
                     <div className="p-4 bg-slate-50 dark:bg-slate-700/50 rounded-2xl space-y-4">
                  ...
                  <SmartSection title="تصدير البيانات" sectionKey="settings-export" defaultOpen={true}>
                     <div className="p-4 bg-slate-50 dark:bg-slate-700/50 rounded-2xl space-y-4">
                        <h3 className="font-bold text-slate-900 dark:text-white flex items-center gap-2">
