   ...
   return (
      <SmartSectionProvider>
         <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4">
            ...
            {/* Stats Row */}
            <SmartSection title="إحصائيات اليوم" sectionKey="dashboard-stats" defaultOpen={true}>
            ...
            {/* Tips & Guidance Row */}
            <SmartSection title="التوجيهات والمستجدات" sectionKey="dashboard-tips" defaultOpen={true}>
            ...
            <SmartSection title="مجمل الإحصائيات الشهرية" sectionKey="dashboard-chart" defaultOpen={true}>
