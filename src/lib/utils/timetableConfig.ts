export interface TimetableTimingConfig {
  stageTitle: string;
  systemTitle: string;
  morningRecessTime: string; // e.g. '09:30 - 09:45' or '10:00 - 10:15'
...
export const getTimetableTimingConfig = (stage?: string, system?: string): TimetableTimingConfig => {
  ...
  if (isPrimary) {
    ...
    return {
      ...
      morningRecessTime: '10:00 - 10:15',
      morningHours: ['08:00 - 09:00', '09:00 - 10:00', '10:15 - 11:05', '11:05 - 12:00'],
      morningDurations: ['1 سا', '1 سا', '50 د', '55 د'],
      middayTime: '12:00 - 13:00',
      afternoonHours: ['13:00 - 14:00', '14:00 - 15:00', '15:15 - 16:05', '16:05 - 17:00'],
      afternoonDurations: ['1 سا', '1 سا', '50 د', '55 د'],
      afternoonRecessTime: '15:00 - 15:15',
      endTime: '17:00',
