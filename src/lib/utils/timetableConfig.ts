...
export const getTimetableTimingConfig = (stage?: string, system?: string): TimetableTimingConfig => {
  ...
  if (isPrimary) {
    ...
    return {
      ...
      afternoonHours: ['13:00 - 14:00', '14:00 - 15:00', '15:10 - 16:05', '16:05 - 17:00'],
      afternoonDurations: ['1 سا', '1 سا', '55 د', '55 د'],
      afternoonRecessTime: '15:00 - 15:10',
      afternoonRecessDuration: '10 د',
      endTime: '17:00',
