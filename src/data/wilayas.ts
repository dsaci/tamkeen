...
export const wildayas: Wilaya[] = [
    ...
    { id: "36", code: "36", name: "El Tarf", ar_name: "الطرف" },
    ...
    { id: "49", code: "49", name: "Timimoun", ar_name: "تيميمون" },
    { id: "50", code: "50", name: "Bordj Badji Mokhtar", ar_name: "برج باجي مختار" },
    { id: "51", code: "51", name: "Ouled Djellal", ar_name: "أولاد جلال" },
    { id: "52", code: "52", name: "Béni Abbès", ar_name: "بني عباس" },
    { id: "53", code: "53", name: "In Salah", ar_name: "عين صالح" },
    { id: "54", code: "54", name: "In Guezzam", ar_name: "عين قزام" },
    { id: "55", code: "55", name: "Touggourt", ar_name: "تقرت" },
    { id: "56", code: "56", name: "Djanet", ar_name: "جانت" },
    { id: "57", code: "57", name: "El M'Ghaier", ar_name: "المغير" },
    { id: "58", code: "58", name: "El Meniaa", ar_name: "المنيعة" },
    // New Wilayas 2025
    { id: "59", code: "59", name: "Aflou", ar_name: "أفلو" },
    { id: "60", code: "60", name: "El Abiodh Sidi Cheikh", ar_name: "الأبيض سيدي الشيخ" },
    { id: "61", code: "61", name: "El Aricha", ar_name: "العريشة" },
    { id: "62", code: "62", name: "El Kantara", ar_name: "القنطرة" },
    { id: "63", code: "63", name: "Barika", ar_name: "بريكة" },
    { id: "64", code: "64", name: "Bou Saâda", ar_name: "بوسعادة" },
    { id: "65", code: "65", name: "Bir El Ater", ar_name: "بئر العاتر" },
    { id: "66", code: "66", name: "Ksar El Boukhari", ar_name: "قصر البخاري" },
    { id: "67", code: "67", name: "Ksar Chellala", ar_name: "قصر الشلالة" },
    { id: "68", code: "68", name: "Aïn Oussera", ar_name: "عين وسارة" },
    { id: "69", code: "69", name: "Messaad", ar_name: "مسعد" },
];
